...
**<li>** [Измерение расстояния по координатам](https://kkadikin.ru/ru/blog/article_018/ "Описание методики реализации механизма расчета расстояния между 2-мя точками маршрута")


**<li>** [Стандарты разработки отчетов](https://kkadikin.ru/ru/blog/article_019/ "Личные стандарты разработки отчетов от Собаки Смайла")
