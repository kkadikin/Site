...
**<li>** На основании полученного списка, в зависимости от ваших потребностей, добавить необходимые аналитические разрезы, например, год, номер и название квартала, номер и название месяца. В принципе - это минимально необходимый набор, который используют все.

**<li>** Дополнительно можно добавить градацию по неделям (пригодится для создания платежногокалендаря), или дням недели (бывает нужно при логистике, посменной работе и пр.)
